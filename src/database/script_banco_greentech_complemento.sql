...
insert into estufa (fkEmpresa, idEstufa, nomeEstufa, tamanho, tipo, minTemp, maxTemp, minUmidade, maxUmidade)
	values (500, 2, 'Estufa Red 02', '1 hec', 'Tomate', 12.00, 28.00, 65.00, 95.00);
...
insert into Estufa (fkEmpresa, idEstufa, nomeEstufa, tamanho, tipo, minTemp, maxTemp, minUmidade, maxUmidade)
	VALUES (500, 3, 'Estufa Red 03', '3 Hec', 'Tomate-Cereja', 14.00, 25.00, 65.00, 95.00);
...
select nomeEstufa, count(idMonitoramento) as 'qtde	' from monitoramentosensor inner join estufa on estufa.idEstufa = monitoramentosensor.fkestufa group by nomeEstufa;

insert into monitoramentosensor (dht11_temperatura, dht11_umidade, luminosidade, lm35_temperatura, chave, momento, fkEmpresa, fkEstufa)
	values (31.00, 76.00, 800, 26.00, 1, now(), 500, 2);

insert into monitoramentosensor (dht11_temperatura, dht11_umidade, luminosidade, lm35_temperatura, chave, momento, fkEmpresa, fkEstufa)
	values (32.00, 78.00, 850, 28.00, 1, now(), 500, 1);
